...
var (
	...
	// created the same way as poetryMany, but without filtering "dev"
	poetryManyIncludingDev = []types.Library{
		{ID: "attrs@22.2.0", Name: "attrs", Version: "22.2.0"},
		{ID: "backports-cached-property@1.0.2", Name: "backports-cached-property", Version: "1.0.2"},
		{ID: "build@0.10.0", Name: "build", Version: "0.10.0"},
		{ID: "cachecontrol@0.12.11", Name: "cachecontrol", Version: "0.12.11"},
		{ID: "cachy@0.3.0", Name: "cachy", Version: "0.3.0"},
		{ID: "certifi@2022.12.7", Name: "certifi", Version: "2022.12.7"},
		{ID: "cffi@1.15.1", Name: "cffi", Version: "1.15.1"},
		{ID: "cfgv@3.3.1", Name: "cfgv", Version: "3.3.1"},
		{ID: "charset-normalizer@3.0.1", Name: "charset-normalizer", Version: "3.0.1"},
		{ID: "cleo@2.0.1", Name: "cleo", Version: "2.0.1"},
		{ID: "colorama@0.4.6", Name: "colorama", Version: "0.4.6"},
		{ID: "coverage@7.1.0", Name: "coverage", Version: "7.1.0"},
		{ID: "crashtest@0.4.1", Name: "crashtest", Version: "0.4.1"},
		{ID: "cryptography@39.0.0", Name: "cryptography", Version: "39.0.0"},
		{ID: "deepdiff@6.2.2", Name: "deepdiff", Version: "6.2.2"},
		{ID: "deepdiff@6.2.3", Name: "deepdiff", Version: "6.2.3"},
		{ID: "distlib@0.3.6", Name: "distlib", Version: "0.3.6"},
		{ID: "dulwich@0.21.2", Name: "dulwich", Version: "0.21.2"},
		{ID: "exceptiongroup@1.1.0", Name: "exceptiongroup", Version: "1.1.0"},
		{ID: "execnet@1.9.0", Name: "execnet", Version: "1.9.0"},
		{ID: "filelock@3.9.0", Name: "filelock", Version: "3.9.0"},
		{ID: "html5lib@1.1", Name: "html5lib", Version: "1.1"},
		{ID: "httpretty@1.1.4", Name: "httpretty", Version: "1.1.4"},
		{ID: "identify@2.5.17", Name: "identify", Version: "2.5.17"},
		{ID: "idna@3.4", Name: "idna", Version: "3.4"},
		{ID: "importlib-metadata@6.0.0", Name: "importlib-metadata", Version: "6.0.0"},
		{ID: "importlib-resources@5.10.2", Name: "importlib-resources", Version: "5.10.2"},
		{ID: "iniconfig@2.0.0", Name: "iniconfig", Version: "2.0.0"},
		{ID: "installer@0.6.0", Name: "installer", Version: "0.6.0"},
		{ID: "jaraco-classes@3.2.3", Name: "jaraco-classes", Version: "3.2.3"},
		{ID: "jeepney@0.8.0", Name: "jeepney", Version: "0.8.0"},
		{ID: "jsonschema@4.17.3", Name: "jsonschema", Version: "4.17.3"},
		...
		{ID: "more-itertools@9.0.0", Name: "more-itertools", Version: "9.0.0"},
		{ID: "msgpack@1.0.4", Name: "msgpack", Version: "1.0.4"},
		{ID: "mypy@1.0.0", Name: "mypy", Version: "1.0.0"},
		{ID: "mypy-extensions@0.4.3", Name: "mypy-extensions", Version: "0.4.3"},
		{ID: "nodeenv@1.7.0", Name: "nodeenv", Version: "1.7.0"},
		{ID: "ordered-set@4.1.0", Name: "ordered-set", Version: "4.1.0"},
		{ID: "orjson@3.8.5", Name: "orjson", Version: "3.8.5"},
		{ID: "packaging@23.0", Name: "packaging", Version: "23.0"},
		{ID: "pexpect@4.8.0", Name: "pexpect", Version: "4.8.0"},
		{ID: "pkginfo@1.9.6", Name: "pkginfo", Version: "1.9.6"},
		{ID: "pkgutil-resolve-name@1.3.10", Name: "pkgutil-resolve-name", Version: "1.3.10"},
		{ID: "platformdirs@2.6.2", Name: "platformdirs", Version: "2.6.2"},
		{ID: "pluggy@1.0.0", Name: "pluggy", Version: "1.0.0"},
		{ID: "poetry-core@1.5.0", Name: "poetry-core", Version: "1.5.0"},
		{ID: "poetry-plugin-export@1.3.0", Name: "poetry-plugin-export", Version: "1.3.0"},
		{ID: "pre-commit@2.21.0", Name: "pre-commit", Version: "2.21.0"},
		{ID: "psutil@5.9.4", Name: "psutil", Version: "5.9.4"},
		{ID: "ptyprocess@0.7.0", Name: "ptyprocess", Version: "0.7.0"},
		{ID: "pycparser@2.21", Name: "pycparser", Version: "2.21"},
		{ID: "pyproject-hooks@1.0.0", Name: "pyproject-hooks", Version: "1.0.0"},
		{ID: "pyrsistent@0.19.3", Name: "pyrsistent", Version: "0.19.3"},
		{ID: "pytest@7.2.1", Name: "pytest", Version: "7.2.1"},
		{ID: "pytest-cov@4.0.0", Name: "pytest-cov", Version: "4.0.0"},
		{ID: "pytest-github-actions-annotate-failures@0.1.8", Name: "pytest-github-actions-annotate-failures", Version: "0.1.8"},
		{ID: "pytest-mock@3.10.0", Name: "pytest-mock", Version: "3.10.0"},
		{ID: "pytest-randomly@3.12.0", Name: "pytest-randomly", Version: "3.12.0"},
		{ID: "pytest-xdist@3.1.0", Name: "pytest-xdist", Version: "3.1.0"},
		{ID: "pywin32-ctypes@0.2.0", Name: "pywin32-ctypes", Version: "0.2.0"},
		{ID: "pyyaml@6.0", Name: "pyyaml", Version: "6.0"},
		{ID: "rapidfuzz@2.13.7", Name: "rapidfuzz", Version: "2.13.7"},
		{ID: "requests@2.28.2", Name: "requests", Version: "2.28.2"},
		{ID: "requests-toolbelt@0.10.1", Name: "requests-toolbelt", Version: "0.10.1"},
		{ID: "secretstorage@3.3.3", Name: "secretstorage", Version: "3.3.3"},
		{ID: "setuptools@67.0.0", Name: "setuptools", Version: "67.0.0"},
		{ID: "shellingham@1.5.0.post1", Name: "shellingham", Version: "1.5.0.post1"},
		{ID: "six@1.16.0", Name: "six", Version: "1.16.0"},
		{ID: "tomli@2.0.1", Name: "tomli", Version: "2.0.1"},
		{ID: "tomlkit@0.11.6", Name: "tomlkit", Version: "0.11.6"},
		{ID: "trove-classifiers@2023.1.20", Name: "trove-classifiers", Version: "2023.1.20"},
		{ID: "typed-ast@1.5.4", Name: "typed-ast", Version: "1.5.4"},
		{ID: "types-html5lib@1.1.11.11", Name: "types-html5lib", Version: "1.1.11.11"},
		{ID: "types-jsonschema@4.17.0.3", Name: "types-jsonschema", Version: "4.17.0.3"},
		{ID: "types-requests@2.28.11.8", Name: "types-requests", Version: "2.28.11.8"},
		{ID: "types-urllib3@1.26.25.4", Name: "types-urllib3", Version: "1.26.25.4"},
		{ID: "typing-extensions@4.4.0", Name: "typing-extensions", Version: "4.4.0"},
		{ID: "urllib3@1.26.14", Name: "urllib3", Version: "1.26.14"},
		{ID: "virtualenv@20.16.5", Name: "virtualenv", Version: "20.16.5"},
		{ID: "virtualenv@20.17.1", Name: "virtualenv", Version: "20.17.1"},
	...
	// create the same way as poetryManyDeps, but don't filer "dev"
	poetryManyDepsIncludingDev = []types.Dependency{types.Dependency{ID: "build@0.10.0", DependsOn: []string{"colorama@0.4.6", "importlib-metadata@6.0.0", "packaging@23.0", "pyproject-hooks@1.0.0", "tomli@2.0.1"}}, types.Dependency{ID: "cachecontrol@0.12.11", DependsOn: []string{"lockfile@0.12.2", "msgpack@1.0.4", "requests@2.28.2"}}, types.Dependency{ID: "cffi@1.15.1", DependsOn: []string{"pycparser@2.21"}}, types.Dependency{ID: "cleo@2.0.1", DependsOn: []string{"crashtest@0.4.1", "rapidfuzz@2.13.7"}}, types.Dependency{ID: "coverage@7.1.0", DependsOn: []string{"tomli@2.0.1"}}, types.Dependency{ID: "cryptography@39.0.0", DependsOn: []string{"cffi@1.15.1"}}, types.Dependency{ID: "deepdiff@6.2.2", DependsOn: []string{"ordered-set@4.1.0"}}, types.Dependency{ID: "deepdiff@6.2.3", DependsOn: []string{"ordered-set@4.1.0", "orjson@3.8.5"}}, types.Dependency{ID: "dulwich@0.21.2", DependsOn: []string{"typing-extensions@4.4.0", "urllib3@1.26.14"}}, types.Dependency{ID: "html5lib@1.1", DependsOn: []string{"six@1.16.0", "webencodings@0.5.1"}}, types.Dependency{ID: "importlib-metadata@6.0.0", DependsOn: []string{"typing-extensions@4.4.0", "zipp@3.12.0"}}, types.Dependency{ID: "importlib-resources@5.10.2", DependsOn: []string{"zipp@3.12.0"}}, types.Dependency{ID: "jaraco-classes@3.2.3", DependsOn: []string{"more-itertools@9.0.0"}}, types.Dependency{ID: "jsonschema@4.17.3", DependsOn: []string{"attrs@22.2.0", "importlib-metadata@6.0.0", "importlib-resources@5.10.2", "pkgutil-resolve-name@1.3.10", "pyrsistent@0.19.3", "typing-extensions@4.4.0"}}, types.Dependency{ID: "keyring@23.13.1", DependsOn: []string{"importlib-metadata@6.0.0", "importlib-resources@5.10.2", "jaraco-classes@3.2.3", "jeepney@0.8.0", "pywin32-ctypes@0.2.0", "secretstorage@3.3.3"}}, types.Dependency{ID: "mypy@1.0.0", DependsOn: []string{"mypy-extensions@0.4.3", "tomli@2.0.1", "typed-ast@1.5.4", "typing-extensions@4.4.0"}}, types.Dependency{ID: "nodeenv@1.7.0", DependsOn: []string{"setuptools@67.0.0"}}, types.Dependency{ID: "pexpect@4.8.0", DependsOn: []string{"ptyprocess@0.7.0"}}, types.Dependency{ID: "platformdirs@2.6.2", DependsOn: []string{"typing-extensions@4.4.0"}}, types.Dependency{ID: "pluggy@1.0.0", DependsOn: []string{"importlib-metadata@6.0.0"}}, types.Dependency{ID: "poetry-core@1.5.0", DependsOn: []string{"importlib-metadata@6.0.0"}}, types.Dependency{ID: "poetry-plugin-export@1.3.0", DependsOn: []string{"poetry-core@1.5.0"}}, types.Dependency{ID: "pre-commit@2.21.0", DependsOn: []string{"cfgv@3.3.1", "identify@2.5.17", "importlib-metadata@6.0.0", "nodeenv@1.7.0", "pyyaml@6.0", "virtualenv@20.16.5"}}, types.Dependency{ID: "pyproject-hooks@1.0.0", DependsOn: []string{"tomli@2.0.1"}}, types.Dependency{ID: "pytest@7.2.1", DependsOn: []string{"attrs@22.2.0", "colorama@0.4.6", "exceptiongroup@1.1.0", "importlib-metadata@6.0.0", "iniconfig@2.0.0", "packaging@23.0", "pluggy@1.0.0", "tomli@2.0.1"}}, types.Dependency{ID: "pytest-cov@4.0.0", DependsOn: []string{"coverage@7.1.0", "pytest@7.2.1"}}, types.Dependency{ID: "pytest-github-actions-annotate-failures@0.1.8", DependsOn: []string{"pytest@7.2.1"}}, types.Dependency{ID: "pytest-mock@3.10.0", DependsOn: []string{"pytest@7.2.1"}}, types.Dependency{ID: "pytest-randomly@3.12.0", DependsOn: []string{"importlib-metadata@6.0.0", "pytest@7.2.1"}}, types.Dependency{ID: "pytest-xdist@3.1.0", DependsOn: []string{"execnet@1.9.0", "psutil@5.9.4", "pytest@7.2.1"}}, types.Dependency{ID: "requests@2.28.2", DependsOn: []string{"certifi@2022.12.7", "charset-normalizer@3.0.1", "idna@3.4", "urllib3@1.26.14"}}, types.Dependency{ID: "requests-toolbelt@0.10.1", DependsOn: []string{"requests@2.28.2"}}, types.Dependency{ID: "secretstorage@3.3.3", DependsOn: []string{"cryptography@39.0.0", "jeepney@0.8.0"}}, types.Dependency{ID: "types-requests@2.28.11.8", DependsOn: []string{"types-urllib3@1.26.25.4"}}, types.Dependency{ID: "virtualenv@20.16.5", DependsOn: []string{"distlib@0.3.6", "filelock@3.9.0", "platformdirs@2.6.2"}}, types.Dependency{ID: "virtualenv@20.17.1", DependsOn: []string{"distlib@0.3.6", "filelock@3.9.0", "importlib-metadata@6.0.0", "platformdirs@2.6.2"}}, types.Dependency{ID: "xattr@0.10.1", DependsOn: []string{"cffi@1.15.1"}}}
